...
namespace ServerApp.Repo
{
    public class StudentRepository : IStudentRepository
    {
        ...
        {
            return await _context.Users.Include(nameof(Classroom)).ToListAsync();
        }
        ...
        {
           return await _context.Users.Include(nameof(Classroom)).FirstOrDefaultAsync(x=>x.Id==userId);
        }
        ...
        public async Task<User> UpdateUser(int userId, User user)
        {
              ...
              if(existstudent!=null){
                ...
                //   existstudent.ClassesId=user.ClassesId;
        ...
        public async Task<List<Classroom>> GetClassByUserId(int id)
        {
            var user = await GetUserAsync(id);
           
            if(user != null){
                return user.Classroom.ToList();
             }
        return null;
        }

        public async Task<List<Classroom>> GetAllClass()
        {
            return await _context.Classrooms.Include(nameof(User)).ToListAsync();
        }

        public async Task<Classroom> GetClass(int classId)
        {
          return await _context.Classrooms.Include(nameof(User)).FirstOrDefaultAsync(x=>x.Id==classId);
        }
        ...
        // public async Task<List<User>> GetUserByClassId(int id)
        // {
        //    var classees = await GetClassById(id);
